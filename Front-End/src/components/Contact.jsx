...
export default function Contact() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm("gmail", "template_nxrb07z", form.current, "eCJkrvRxhE1uRyQ0G")
      .then(
        (result) => {
    ...
    <>
      ...
      <div className="d-flex mt-5 col-8 m-auto justify-content-around">
        ...
        >
          ...
          ></textarea>
          <div>
            <button className="button" value="Send message">
              Submit
            </button>
        ...
        <div className="d-flex flex-column col-4">
          <div className="d-flex">
            <img
              className="icon1"
              src="http://localhost:3000/pictures/marker.svg"
              alt=""
            />
            <a
              className="phone"
          ...
          <div className="d-flex">
            <img
              className="icon1 mt-2"
              src="http://localhost:3000/pictures/phone-call.svg"
              alt=""
            />
          ...
          <div className="d-flex mt-3">
            <img
              className="icon1"
              src="http://localhost:3000/pictures/envelope.svg"
              alt=""
            />
